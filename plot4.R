...
## This section produces and saves plot of four charts as a png.
png(filename = "plot4.png")
par(mfrow = c(2, 2))
with (pwconsump, {
plot(pwconsump$V2, pwconsump$V3, xlab = "", ylab = "Global Active Power (kilowatts)", type = "l")    
plot(pwconsump$V2, pwconsump$V5, xlab = "datetime", ylab = "Voltage", type = "l")
plot(pwconsump$V2, pwconsump$V7, xlab = "", ylab = "Energy sub metering", type = "l")
...
plot(pwconsump$V2, pwconsump$V4, xlab = "datetime", ylab = "Global_reactive_power", type = "l")
dev.off()
